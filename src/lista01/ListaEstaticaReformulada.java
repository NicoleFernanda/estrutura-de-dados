...
public class ListaEstaticaReformulada <ClasseQueOProgramadorInformar>{
	
	private ClasseQueOProgramadorInformar info[];
	private int tamanho;
	
	public ListaEstaticaReformulada() {
		info = (ClasseQueOProgramadorInformar[]) new Object[10];
		tamanho = 0;
	}
	
	public void inserir(ClasseQueOProgramadorInformar valor) {
	...
	private void redimensionar() {
		ClasseQueOProgramadorInformar novo[] = (ClasseQueOProgramadorInformar[]) new Object[info.length + 10];
	...
	public int buscar(ClasseQueOProgramadorInformar valor) {
		for (int i = 0; i < tamanho; i++) {
	...
	public void retirar(ClasseQueOProgramadorInformar valor) {
	...
	public ClasseQueOProgramadorInformar obterElemento(int posicao) {
		if(posicao > tamanho) {
			return(info[posicao]);
		} else {
